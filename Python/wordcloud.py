...
#         for i, j in enumerate(input_string.split()):
#             if j in self.words_to_counts:
#                 self.words_to_counts[j] += 1
#             else:
#                 self.words_to_counts[j.lower()] = 1



# their solution is super complex and long. Mine worked with spaces and counting all words
# whether lowercase or not 
class WordCloudData:
